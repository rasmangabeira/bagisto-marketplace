    ...
    <div class="auth-content form-container">
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                ...
                <div class="body col-12" id="signup-app">
                    <h3 class="fw6">
                    ...
                    <form
                        ...
                        <div class="seller-form-controls">
                            <div class="control-group">
                                <label>Do You Want To Become A Seller / Vendor?</label>
                                <span class="radio"><input type="radio" id="yes" name="is_seller" value="1" > <label for="yes" class="radio-view"></label>
                                    Yes
                                </span>
                                <span class="radio"><input type="radio" id="no" name="is_seller" value="0"  > <label for="no" class="radio-view"></label>
                                    No
                                </span>
...
$(document).ready(function(){
    ...
    $('input[type="radio"][name="is_seller"]').click(function(){
