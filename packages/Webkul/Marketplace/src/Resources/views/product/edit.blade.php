...
@section('page-detail-wrapper')
    <div class="content">
        ...
        <form class="account-table-content" method="POST" action="" @submit.prevent="onSubmit" enctype="multipart/form-data">
    ...
    <script>
        $(document).ready(function () {
            $('#channel-switcher, #locale-switcher').on('change', function (e) {
                ...
                window.location.href = "{{ route('seller.products.edit', $product->id)  }}" + query;
            })
